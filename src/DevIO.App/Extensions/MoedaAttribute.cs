...
namespace DevIO.App.Extensions
{
    ...
    {
        // esta validação é basicamente obtida somente no lado do Server
        ...
        // Adapter para fazer validação de moeda também do lado do Client
        public class MoedaAttributeAdapter : AttributeAdapterBase<MoedaAttribute>
        {
            ...
            // necessário para poder o Adapter funcionar
